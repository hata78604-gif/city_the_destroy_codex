...
### Phase 9: 危険度昇格時の旧部隊撤退(Step 5-0→Step 5-2で演出変更)

Step5-2で撤退の見た目を「その場でフェード消滅」から「ゲーム上は即無効化→最寄りの街外周へ
高速移動→街の外に出たらDestroy」へ変更した。以下のチェックリストは新しい演出を前提にしている。
...
- [ ] 「軍が出動した!」が表示される
- [ ] ★1旧部隊がその場で消えず、街外周へ高速移動して退場する(Step 5-2の演出。§Phase 9参照)
- [ ] 旧★1が再派遣されない
...
- [ ] 4人を全滅させても即座に次が湧かず、約20秒後に新しいヘリが来る
